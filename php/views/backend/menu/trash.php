                ...
                <table class="table table-bordered" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="index.php?option=menu&cat=detail&id=<?php echo $row['Id'];?>"
                                    title="Chi tiết" class="btn btn-sm btn-primary">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <a href="index.php?option=menu&cat=retrash&id=<?php echo $row['Id'];?>"
                                    title="Cập nhật" class="btn btn-sm btn-info">
                                    <i class="fas fa-undo"></i>
                                </a>

                                <a href="index.php?option=menu&cat=del&id=<?php echo $row['Id'];?>"
